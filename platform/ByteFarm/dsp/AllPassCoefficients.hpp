...
namespace ByteFarm
{
    namespace Dsp
    {
        ...
        {
        public:
            TypedArray<double, SIZE> a_coefficients;
            TypedArray<double, SIZE> b_coefficients;
        ...
        Coefficients<6> *C12S = new Coefficients<6>{
        ...
        Coefficients<5> *C10S = new Coefficients<5>{
        ...
        Coefficients<4> *C8S = new Coefficients<4>{
        ...
        Coefficients<5> *C10G = new Coefficients<5>{
        ...
        Coefficients<4> *C8G = new Coefficients<4>{
