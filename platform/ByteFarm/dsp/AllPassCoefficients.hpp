...
namespace ByteFarm
{
    namespace Dsp
    {
        ...
        {
        public:
            TypedArray<float, SIZE, uint8_t> a_coefficients;
            TypedArray<float, SIZE, uint8_t> b_coefficients;
            const uint8_t NumCoefficients;
            Coefficients(std::initializer_list<float> a, std::initializer_list<float> b, uint8_t numcoefficients) : a_coefficients{a},
                                                                                                                      b_coefficients{b},
